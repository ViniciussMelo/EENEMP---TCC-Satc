...
if (isset($_SESSION["logado"]) && !empty($_SESSION["logado"])) {
	 echo "<script language='javascript' type='text/javascript'>
                    window.location.href='logadoAluno.php';</script>";
                    die();
}
if(isset($_SESSION["logadoProf"]) && !empty($_SESSION["logadoProf"])) {
     echo "<script language='javascript' type='text/javascript'>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/fundo/bg.jpg');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article class="introtxt">
      <h2 class="heading"><b>Preparatório ENEM</b> <i><strong>Venha e aprenda.</strong> Cadastre-se já!</h2></i>
      <p>Torne-se o mais preparado para o ENEM! Confira.</p>
  ...
  <section class="hoc container clear"> 
    ...
    <article id="questao">
       <ul style="list-style-type: none;">
                ...
                <li align="" >        <a href="" onClick="mensagem();">Espanhol </a></li>
        <li align="" ><a href="" onClick="mensagem();"> Fisica </a></li>
       <li align="" > <a href="" onClick="mensagem();">Geografia </a></li>
       <li align="" > <a href="" onClick="mensagem();"> Historia </a></li>
    
    <li align="" ><a href="" onClick="mensagem();"> Ingles </a></li>  
    <li align="" ><a href="" onClick="mensagem();"> Matematica </a></li>
    <li align="" ><a href="" onClick="mensagem();"> Portugues </a></li>
    <li align="" ><a href="" onClick="mensagem();"> Quimica </a>  </li>
      </ul>
    </article>
...
<script>
function mensagem(){
			alert("Cadastre-se agora mesmo para ter acesso as questões!!");
		}
</script>
</body>
</html>