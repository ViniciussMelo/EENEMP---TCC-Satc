...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/fundo/bg.jpg');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article class="introtxt">
      <h2 class="heading"><b>Obrigado por se cadastrar Professor!</b></h2>
      <p>Cadastre e veja as questões! Comece já.</p>
		<p><a class="btn medium" href="cadastroMaterias.php">Cadastrar questões</a>
		<a class="btn medium" href="questaopravoceProf.php">Ver questões</a></p>
    </article>
    <!-- ################################################################################################ -->
  </div>
</div>
