...
<html>
<head>
<title>EENEMP/Login Aluno</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
	...
	<div class="cadastro">
     <form class="formulario" onSubmit="return validaCampo();" method="POST" action="loginAluno.php">
        <fieldset>
            <h3>Login</h3>
			
			<input type="email" id="emailA" name="emailA" placeholder="Email do Aluno">
            
            <input type="password" id="senhaA" name="senhaA" placeholder="Senha do Aluno">

            <input type="submit" name="login" class="login" value="Login">
			<a href="recuperarSenhaAluno.php"><b>Esqueci minha senha</b></a>
        </fieldset>
     </form>
       </div>
...
<script>
	function validaCampo(){
		...
		if(senhaA.value == ""){
			...
			document.getElementById("senhaA").focus();
			return false;
		}
	}
</script>	
