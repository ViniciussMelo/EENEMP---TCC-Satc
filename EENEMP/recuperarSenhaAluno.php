...
if (isset($_POST['login']))
{
	...
	$verifica = ("SELECT emailAluno,respostaSeguranca FROM cadastroaluno WHERE emailAluno = '$emailR' AND respostaSeguranca='$rSeguranca'");
	$res = mysql_query($verifica);
	
	if(mysql_num_rows($res) != 0){
		mysql_query("UPDATE cadastroAluno SET senhaAluno='novaSenha' WHERE emailAluno='$emailR'");
		echo"<script language='javascript' type='text/javascript'>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
	...
	<div class="cadastro">
     ...
     <form class="formulario" method="POST" action="recuperarSenhaAluno.php">
        <fieldset>
            <h3>Login</h3>
			
			<input type="email" required id="emailR" name="emailR" placeholder="Email:">
            <input type="text" readOnly="true" id="usuarioR" name="usuarioR" value="Aluno">
