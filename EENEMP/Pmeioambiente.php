<?php
	...
	$_SESSION["questao10"] = $questao10;
	 ...
	 echo"<script language='javascript' type='text/javascript'>
		  ...
		  window.location.href='Rmeioambiente.php';</script>";
          die();
...
<html>
	...
	<div id="all">
		<form id="titulo">
			<h1>Prova de Quimica sobre <font color=red>Meio ambiente</h1></font>
		</form>
		
		<form id="questoes" action="Pmeioambiente.php" method = "POST">
			<br>
			<h2>1) 1-Há estudos que apontam razões
...
outros motivos, porque o gás natural </h2>
			<p>
			<label>
			<input type="radio" name="questao1" value="a" />A) além de muito abundante na natureza é um combustível
renovável;</label>
			<br />
			<label>
			<input type="radio" name="questao1" value="b" />B) tem novas jazidas sendo exploradas e é menos poluente
que o petróleo;</label>
			<br />
			<label>
			<input type="radio" name="questao1" value="c" />C) vem sendo produzido com sucesso a partir do carvão
mineral;</label>
			<br />
			<label>
			<input type="radio" name="questao1" value="d" />D) pode ser renovado em escala de tempo muito inferior à
do petróleo;</label>
			<br />
			<label>
			<input type="radio" name="questao1" value="e" />E)não produz CO2 em sua queima, impedindo o efeito
estufa.</label>
			<br />
			<br />
...
do petróleo, no que diz respeito ao fenômeno.</h2>
			...
			<label>
			<input type="radio" name="questao2" value="a" /> A)  da chuva ácida;></label>
			<br />
			<label>
			<input type="radio" name="questao2" value="b" /> B) da destruição da camada de ozônio.></label>
			<br />
			<label>
			<input type="radio" name="questao2" value="c" /> C) do efeito estufa.></label>
			<br />
			<label>
			<input type="radio" name="questao2" value="d" /> D) da inversão térmica.></label>
			<br />
			<label>
			<input type="radio" name="questao2" value="e" /> E) do efeito tyndall. ></label>
			<br />
			<br />
